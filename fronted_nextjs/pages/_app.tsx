        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-40">
              <a
                href="https://youtu.be/1vmhqf6_Y_w?si=uu61H4WcEZgRdbdA"
                target="_blank"
                rel="noreferrer"
                aria-label="Ver video demostrativo"
                className="w-20 h-20 rounded-full bg-cyan-500 text-white flex items-center justify-center hover:bg-cyan-600 transition-colors shadow-xl hover:scale-110 transform duration-200"
              >
